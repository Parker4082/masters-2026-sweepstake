/* ============================================
   ...
   Updated: April 10, 2026 – Round 3 in progress
   All missedCut flags set to false pending official cut announcement.
   ============================================ */
...
const masters2026Field = [
    ...
    { name: "Rory McIlroy", score: -7, rank: 3, missedCut: false, rounds: [0, 0, 0, 0], tier: 1 },
    ...
    { name: "Matt Fitzpatrick", score: 3, rank: 24, missedCut: false, rounds: [0, 0, 0, 0], tier: 2 },
    ...
    { name: "Harry Hall", score: 5, rank: 38, missedCut: false, rounds: [0, 0, 0, 0], tier: 3 },
    { name: "Sungjae Im", score: 1, rank: 39, missedCut: false, rounds: [0, 0, 0, 0], tier: 3 },
    { name: "Kurt Kitayama", score: -1, rank: 40, missedCut: false, rounds: [0, 0, 0, 0], tier: 3 },
    ...
    { name: "Cameron Smith", score: 4, rank: 44, missedCut: false, rounds: [0, 0, 0, 0], tier: 3 },
    { name: "J.J. Spaun", score: 5, rank: 45, missedCut: false, rounds: [0, 0, 0, 0], tier: 3 },
    ...
    { name: "Aldrich Potgieter", score: 15, rank: 50, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    ...
    { name: "Johnny Keefer", score: 11, rank: 60, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    ...
    { name: "Li Haotong", score: -3, rank: 63, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    ...
    { name: "José María Olazábal", score: 9, rank: 77, missedCut: false, rounds: [0, 0, 0, 0], tier: 5 },
    ...
    { name: "Naoyuki Kataoka", score: 14, rank: 82, missedCut: false, rounds: [0, 0, 0, 0], tier: 5 },
    { name: "Rasmus Neergaard-Petersen", score: 5, rank: 83, missedCut: false, rounds: [0, 0, 0, 0], tier: 5 },
    { name: "Kristoffer Reitan", score: -1, rank: 84, missedCut: false, rounds: [0, 0, 0, 0], tier: 5 },
    ...
    // TIER 6 - Amateurs
    { name: "Mason Howell", score: 7, rank: 87, missedCut: false, rounds: [0, 0, 0, 0], tier: 6 },
    { name: "Jackson Herrington", score: 8, rank: 88, missedCut: false, rounds: [0, 0, 0, 0], tier: 6 },
    ...
    { name: "Brandon Holtz", score: 12, rank: 92, missedCut: false, rounds: [0, 0, 0, 0], tier: 6 },
];
