...
const masters2026Field = [
    ...
    { name: "Rory McIlroy", score: 0, rank: 3, missedCut: false, rounds: [0, 0, 0, 0], tier: 1 },
    { name: "Cameron Young", score: 0, rank: 4, missedCut: false, rounds: [0, 0, 0, 0], tier: 1 },
    { name: "Justin Rose", score: 0, rank: 5, missedCut: false, rounds: [0, 0, 0, 0], tier: 1 },
    { name: "Collin Morikawa", score: 0, rank: 6, missedCut: false, rounds: [0, 0, 0, 0], tier: 1 },
    { name: "Xander Schauffele", score: 0, rank: 7, missedCut: false, rounds: [0, 0, 0, 0], tier: 1 },
    { name: "Russell Henley", score: 0, rank: 8, missedCut: false, rounds: [0, 0, 0, 0], tier: 1 },
    { name: "Robert MacIntyre", score: 0, rank: 9, missedCut: false, rounds: [0, 0, 0, 0], tier: 1 },
    { name: "Chris Gotterup", score: 0, rank: 10, missedCut: false, rounds: [0, 0, 0, 0], tier: 1 },

    // TIER 2 - World 11-25
    { name: "Viktor Hovland", score: 0, rank: 11, missedCut: false, rounds: [0, 0, 0, 0], tier: 2 },
    ...
    { name: "Tyrrell Hatton", score: 0, rank: 14, missedCut: false, rounds: [0, 0, 0, 0], tier: 2 },
    ...
    { name: "Shane Lowry", score: 0, rank: 17, missedCut: false, rounds: [0, 0, 0, 0], tier: 2 },
    { name: "Akshay Bhatia", score: 0, rank: 18, missedCut: false, rounds: [0, 0, 0, 0], tier: 2 },
    { name: "Sam Burns", score: 0, rank: 19, missedCut: false, rounds: [0, 0, 0, 0], tier: 2 },
    { name: "Wyndham Clark", score: 0, rank: 20, missedCut: false, rounds: [0, 0, 0, 0], tier: 2 },
    { name: "Min Woo Lee", score: 0, rank: 21, missedCut: false, rounds: [0, 0, 0, 0], tier: 2 },
    { name: "Keegan Bradley", score: 0, rank: 22, missedCut: false, rounds: [0, 0, 0, 0], tier: 2 },
    { name: "Jon Rahm", score: 0, rank: 23, missedCut: false, rounds: [0, 0, 0, 0], tier: 2 },
    { name: "Matt Fitzpatrick", score: 0, rank: 24, missedCut: false, rounds: [0, 0, 0, 0], tier: 2 },
    { name: "Bryson DeChambeau", score: 0, rank: 25, missedCut: false, rounds: [0, 0, 0, 0], tier: 2 },

    // TIER 3 - World 26-45
    { name: "Corey Conners", score: 0, rank: 26, missedCut: false, rounds: [0, 0, 0, 0], tier: 3 },
    { name: "Sepp Straka", score: 0, rank: 27, missedCut: false, rounds: [0, 0, 0, 0], tier: 3 },
    ...
    { name: "Jason Day", score: 0, rank: 30, missedCut: false, rounds: [0, 0, 0, 0], tier: 3 },
    ...
    { name: "Tom McKibbin", score: 0, rank: 33, missedCut: false, rounds: [0, 0, 0, 0], tier: 3 },
    { name: "Maverick McNealy", score: 0, rank: 34, missedCut: false, rounds: [0, 0, 0, 0], tier: 3 },
    { name: "Andrew Novak", score: 0, rank: 35, missedCut: false, rounds: [0, 0, 0, 0], tier: 3 },
    { name: "Ryan Fox", score: 0, rank: 36, missedCut: false, rounds: [0, 0, 0, 0], tier: 3 },
    ...
    { name: "J.J. Spaun", score: 0, rank: 45, missedCut: false, rounds: [0, 0, 0, 0], tier: 3 },
    ...
    { name: "Patrick Reed", score: 0, rank: 47, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Jacob Bridgeman", score: 0, rank: 48, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Nico Echavarría", score: 0, rank: 49, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Aldrich Potgieter", score: 0, rank: 50, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Brian Campbell", score: 0, rank: 51, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Max Greyserman", score: 0, rank: 52, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Ryan Gerard", score: 0, rank: 53, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Jake Knapp", score: 0, rank: 54, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Nicolai Højgaard", score: 0, rank: 55, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Matt McCarty", score: 0, rank: 56, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Daniel Berger", score: 0, rank: 57, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Gary Woodland", score: 0, rank: 58, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Michael Kim", score: 0, rank: 59, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Johnny Keefer", score: 0, rank: 60, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Michael Brennan", score: 0, rank: 61, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Carlos Ortiz", score: 0, rank: 62, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
