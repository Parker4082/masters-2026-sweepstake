...
const masters2026Field = [
    // TIER 1 - World top 10
    { name: "Scottie Scheffler", score: -3, rank: 1, missedCut: false, rounds: [0, 0, 0, 0], tier: 1 },
    { name: "Tommy Fleetwood", score: -2, rank: 2, missedCut: false, rounds: [0, 0, 0, 0], tier: 1 },
    ...
    { name: "Justin Rose", score: -2, rank: 5, missedCut: false, rounds: [0, 0, 0, 0], tier: 1 },
    ...
    { name: "Patrick Cantlay", score: 4, rank: 13, missedCut: false, rounds: [0, 0, 0, 0], tier: 2 },
    ...
    { name: "Akshay Bhatia", score: 2, rank: 18, missedCut: false, rounds: [0, 0, 0, 0], tier: 2 },
    ...
    { name: "Min Woo Lee", score: 3, rank: 21, missedCut: false, rounds: [0, 0, 0, 0], tier: 2 },
    { name: "Keegan Bradley", score: 0, rank: 22, missedCut: false, rounds: [0, 0, 0, 0], tier: 2 },
    { name: "Jon Rahm", score: 3, rank: 23, missedCut: false, rounds: [0, 0, 0, 0], tier: 2 },
    { name: "Matt Fitzpatrick", score: 0, rank: 24, missedCut: false, rounds: [0, 0, 0, 0], tier: 2 },
    { name: "Bryson DeChambeau", score: 3, rank: 25, missedCut: false, rounds: [0, 0, 0, 0], tier: 2 },

    // TIER 3 - World 26-45
    { name: "Corey Conners", score: -1, rank: 26, missedCut: false, rounds: [0, 0, 0, 0], tier: 3 },
    ...
    { name: "Ben Griffin", score: 1, rank: 37, missedCut: false, rounds: [0, 0, 0, 0], tier: 3 },
    { name: "Harry Hall", score: 1, rank: 38, missedCut: false, rounds: [0, 0, 0, 0], tier: 3 },
    ...
    { name: "Si Woo Kim", score: 1, rank: 42, missedCut: false, rounds: [0, 0, 0, 0], tier: 3 },
    ...
    { name: "J.J. Spaun", score: 2, rank: 45, missedCut: false, rounds: [0, 0, 0, 0], tier: 3 },
    ...
    { name: "Nicolai Højgaard", score: 3, rank: 55, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Matt McCarty", score: 0, rank: 56, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Daniel Berger", score: 3, rank: 57, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Gary Woodland", score: -2, rank: 58, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Michael Kim", score: 2, rank: 59, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    ...
    { name: "Sam Stevens", score: 1, rank: 66, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Alex Noren", score: 5, rank: 67, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Davis Riley", score: 7, rank: 68, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },
    { name: "Aaron Rai", score: -3, rank: 69, missedCut: false, rounds: [0, 0, 0, 0], tier: 4 },

    // TIER 5 - Past champions / other invitees
    { name: "Adam Scott", score: 2, rank: 70, missedCut: false, rounds: [0, 0, 0, 0], tier: 5 },
    { name: "Sergio García", score: -2, rank: 71, missedCut: false, rounds: [0, 0, 0, 0], tier: 5 },
    ...
    { name: "Mike Weir", score: 5, rank: 75, missedCut: false, rounds: [0, 0, 0, 0], tier: 5 },
    ...
    { name: "Fred Couples", score: -2, rank: 79, missedCut: false, rounds: [0, 0, 0, 0], tier: 5 },
    ...
    // TIER 6 - Amateurs
    { name: "Mason Howell", score: 6, rank: 87, missedCut: false, rounds: [0, 0, 0, 0], tier: 6 },
    ...
    { name: "Fifa Laopakdee", score: 4, rank: 90, missedCut: false, rounds: [0, 0, 0, 0], tier: 6 },
    { name: "Mateo Pulcini", score: 4, rank: 91, missedCut: false, rounds: [0, 0, 0, 0], tier: 6 },
